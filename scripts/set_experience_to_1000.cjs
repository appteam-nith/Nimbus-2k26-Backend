...
(async () => {
  ...
  try {
    ...
    const topRes = await client.query('SELECT user_id, full_name, experience FROM "User" ORDER BY experience DESC, "experience_updated_at" ASC, full_name ASC LIMIT 10');
    console.log('\nTop 10 users:');
